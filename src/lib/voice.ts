 ...
 */
const WAKE =
  /\b(?:hey|hi|ok|okay|yo)?\s*(?:mino|minos|meeno|my no|mino's|know me|mine o)\b(?!'s)/i
 ...
 */
const OVERRIDE =
  /\b(stop|wait|mino|cancel|enough|quiet|hold on|shut up|never ?mind|forget it|no)\b/i
